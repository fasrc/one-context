...
package() {
    cp -rT ${srcdir}/addon-context-linux-4.14.1.2/base_arch/etc ${pkgdir}
    cp -rT ${srcdir}/addon-context-linux-4.14.1.2/base_arch/usr ${pkgdir}
    cp -rT ${srcdir}/addon-context-linux-4.14.1.2/base/etc ${pkgdir}
    cp -rT ${srcdir}/addon-context-linux-4.14.1.2/base/usr ${pkgdir}
